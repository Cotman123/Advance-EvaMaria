...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("😇𝙒𝙝𝙞𝙘𝙝 𝙢𝙤𝙫𝙞𝙚 𝙬𝙤𝙪𝙡𝙙 𝙮𝙤𝙪 𝙡𝙞𝙠𝙚 𝙩𝙤 𝙨𝙚𝙚 ? ᴄʜᴏᴏsᴇ ғʀᴏᴍ ᴛʜᴇ ʟɪsᴛ ʙᴇʟᴏᴡ 📝 ",
                    reply_markup=InlineKeyboardMarkup(btn))
